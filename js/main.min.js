...
/* harmony import */ var _modules_init_range__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-range */ "./js/modules/init-range.js");
/* harmony import */ var _modules_pendulum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/pendulum */ "./js/modules/pendulum.js");
...
Object(_modules_init_range__WEBPACK_IMPORTED_MODULE_2__["initRange"])();
Object(_modules_pendulum__WEBPACK_IMPORTED_MODULE_3__["initPendulum"])();
...
var purchaseSlider = document.querySelector('.js-slider-deviation');
var weightSlider = document.querySelector('.js-slider-weight');
var rigiditySlider = document.querySelector('.js-slider-rigidity');

var initRange = function initRange() {
  // инициализация слайдера изменения первоначального отклонения от равновесия
  if (purchaseSlider) {
    window.deviationSlider = nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(purchaseSlider, {
  ...
  if (weightSlider) {
    window.weightSlider = nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(weightSlider, {
  ...
  if (rigiditySlider) {
    window.rigiditySlider = nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(rigiditySlider, {
...
/***/ "./js/modules/pendulum.js":
/*!********************************!*\
  !*** ./js/modules/pendulum.js ***!
  \********************************/
/*! exports provided: initPendulum */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPendulum", function() { return initPendulum; });
...
var initPendulum = function initPendulum() {
  var breakpointSm = window.matchMedia('(max-width: 767px)');
  var moveTo = new _vendor_move_to__WEBPACK_IMPORTED_MODULE_0___default.a();
  var spring = document.querySelector('.js-spring');
  var springWrap = spring.closest('.visualization');
  var ball = document.querySelector('.js-ball');
  var btn = document.querySelector('.js-start-btn');
  var characteristicFrequency = document.querySelector('.characteristic__block--frequency span');
  var characteristicTime = document.querySelector('.characteristic__block--time span');
  var characteristicQuantity = document.querySelector('.characteristic__block--quantity span');
  var characteristicCoordinate = document.querySelector('.characteristic__block--coordinate span');
  var defaultDuration = 100;
  var deviationInput = document.querySelector('input#deviation');
  var weightInput = document.querySelector('input#weight');
  var rigidityInput = document.querySelector('input#rigidity');
  var minCoordinate = 0;
  var autoPlayTimeout;
  var springHeight = 200;
  var m, k, x0, w0, t;
  var oscillationCounter = -1;
  var startDate;
  var clocktimer; // функция запуска секундомера
  ...
  var getNumberFromPrice = function getNumberFromPrice(str) {
    str = +str.replace(/[^0-9]/g, '');
    return str;
  }; // установка максимальной и минимальной высот пружины


  var minLength = spring.scrollHeight;
  var length = springWrap.scrollHeight - minLength - 120; // функция запуска анимации

  var animateSpring = function animateSpring() {
    spring.style.height = null;
    characteristicCoordinate.innerText = minCoordinate + ' см';
    spring.addEventListener('transitionend', function () {
      spring.style.height = "".concat(springHeight, "px");
  ...
  btn.addEventListener('click', function (evt) {
    ...
    if (!btn.classList.contains('active')) {
      ...
      characteristicQuantity.innerText = oscillationCounter; // отключение возможности изменения параметров
      ...
      document.querySelector('.js-slider-rigidity').setAttribute('disabled', true); // запуск анимации

      spring.style.transitionDuration = "".concat(defaultDuration * w0, "ms");
      animateSpring();
      ...
      document.querySelector('.js-slider-rigidity').removeAttribute('disabled'); // остановка секундомера
  ...
  window.rigiditySlider.on('update', function (values, handle) {
  ...
  window.deviationSlider.on('update', function (values, handle) {
    deviationInput.value = values[handle];
    spring.style.height = "".concat(getNumberFromPrice(values[handle]) * (length / 20) + minLength, "px");
    springHeight = getNumberFromPrice(values[handle]) * (length / 20) + minLength;
  }); // обработчик изменения массы груза

  window.weightSlider.on('update', function (values, handle) {
    weightInput.value = values[handle];
    m = getNumberFromPrice(document.querySelector('input#weight').value) / 10;
    w0 = parseFloat(Math.sqrt(k / m).toFixed(1));
    characteristicFrequency.innerText = w0;
    ball.style.width = "".concat(getNumberFromPrice(values[handle]) / 10 * 120, "px");
    ball.style.height = "".concat(getNumberFromPrice(values[handle]) / 10 * 120, "px");

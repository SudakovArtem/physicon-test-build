...
var initPendulum = function initPendulum() {
  ...
  var m, k, x0, w0, t; // функция преобразования строки с буквами в число
  ...
  btn.addEventListener('click', function (evt) {
    ...
    if (!btn.classList.contains('active')) {
      ...
      t = parseFloat((2 * Math.PI * Math.sqrt(k / m)).toFixed(1)); // запись значений в характеристики

      characteristicTime.innerText = t + ' с';
      characteristicCoordinate.innerText = x0 + ' см';
      characteristicQuantity.innerText = '∞'; // отключение возможности изменения параметров
